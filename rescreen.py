...
class resumeScreener:
    ...
    def screenResume(self,text):
        ...
        with open('assets/colab/feature_tokenizer.pickle', 'rb') as handle:
            feature_tokenizer = pickle.load(handle)

        # Get label encoding dictionary from model training
        with open('assets/colab/dictionary.pickle', 'rb') as handle:
        ...
        model = keras.models.load_model('assets/colab/model')
